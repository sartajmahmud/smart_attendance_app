...
Future<Address> addAddress(Address address) async {
  ...
  try {
    ...
    print("This is Add address $url");
    print("This is add address body ${address.toMap()}");
    print("This is Add delivery address response body ${response.body}");
...
Future<Address> removeDeliveryAddress(Address address) async {
  ...
  try {
    ...
    print("This is remove delivery address $url");
    print("This is remove delivery address response body ${response.body}");
    return Address.fromJSON(json.decode(response.body)['data']);
  } catch (e) {
    print(CustomTrace(StackTrace.current, message: url));
    return new Address.fromJSON({});
